...
export default function Header() {
  ...
  return (
    <header className="">
      <div
        className="z-[9999] fixed w-full bg-white flex justify-between items-center font-merriweather py-8
       px-4 md:px-12 lg:px-32 gap-8"
      >
        <Link to="">
        ...
        <nav
          ref={navRef}
          className="hidden lg:flex lg:gap-7 font-normal lg:text-[18px]"
        >
