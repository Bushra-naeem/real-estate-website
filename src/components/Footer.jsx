...
export default function Footer() {
  return (
    <>
      <footer className="bg-slate-800 text-white flex flex-col font-merriweather space-y-2 lg:space-y-0 lg:flex-row px-8 md:px-32 lg:px-24 py-20 sm:py-24 gap-16 lg:gap-24">
        <div className="w-full lg:w-1/3 flex flex-col text-base md:text-lg gap-8 sm:gap-10">
          <div className="">
            ...
            <p>
              ...
              industry. Lorem Ipsum is dummy text of the industry.
            </p>
          </div>
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          <div className="flex flex-col gap-8">
            <h1 className="text-2xl lg:text-3xl font-bold">Company</h1>
      ...
      <div className="text-center text-white p-6 sm:p-7 font-merriweather text-base md:text-lg bg-slate-900 mb-16 sm:mb-0">
