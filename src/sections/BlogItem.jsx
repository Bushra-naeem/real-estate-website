...
const BlogItem = ({image, user, features, heading, date, text}) => {
    return(
        <div className="w-full flex flex-col bg-white gap-5 my-8 shadow-xl">
            <img src={image} alt="image" className="w-full h-auto" />
            <div className="flex w-full gap-8 px-8 mt-3 text-gray-700 font-normal">
            <p className="flex gap-1"><span className="mt-1"><FaUser /></span><span>{user}</span></p>
            <p className="flex gap-1"><span className="mt-1"><IoIosPricetags /></span>
            ...
            <p className="text-gray-700 flex gap-1"><span className="mt-1"><MdOutlineDateRange />
