...
const PropertyItem = ({
  ...
  return (
    <div className="w-full flex flex-col flex-grow font-merriweather bg-white gap-3 my-8 shadow-xl">
      <img src={image} alt="" className="w-[1200px] h-80" />
      <p className="text-red-500 font-semibold px-8">{price}</p>
      <p className="font-bold font-mono px-8 text-2xl lg:text-3xl">{heading}</p>
