...
export default function Contact() {
  return (
    <section id="contact" className="px-8 py-20 font-merriweather scroll-mt-16">
      <h2 className="text-5xl font-bold text-center sm:text-6xl mb-6">
        Contact Us
      </h2>
      <form
        action=""
      ...
      >
        ...
        ></textarea>
        <button className="bg-zinc-600 hover:bg-zinc-500 text-white p-3 w-48 rounded-xl border border-solid border-slate-900">
          Submit
        </button>
      </form>
    </section>
