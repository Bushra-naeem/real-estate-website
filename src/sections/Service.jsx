...
export default function Service() {
  return (
    <section
      className="bg-slate-50 flex flex-col items-center justify-center md:flex-wrap gap-5 py-24 px-3 lg:px-28"
      id="service"
    >
      <button className="text-red-500 font-semibold border-2 border-pink-100 py-1 px-3 bg-pink-50 rounded-3xl">
        Our Services
      </button>
      <h1 className="text-2xl sm:text-5xl font-bold">Our Main Focus</h1>
